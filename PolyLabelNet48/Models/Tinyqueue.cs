...
namespace PolyLabelNet
{
    ...
    /// original Mapbox Polylabel. Provides the priority queue on .NET Framework, which lacks the
    /// .NET 6+ <see cref="System.Collections.Generic.PriorityQueue{TElement, TPriority}"/>.
    /// </summary>
    internal class Tinyqueue<T>
    {
